...
<!-- Please read the https://github.com/linuxserver/docker-sonarr/blob/develop/.github/CONTRIBUTING.md -->
...
* Update the image: `docker pull lscr.io/linuxserver/sonarr:develop`
